...
<head>
    ...
    <link rel="shortcut icon" href="assets/dist/img/logo.jpeg" type="image/x-icon">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="assets/dist/img/logo.jpeg" alt="AdminLTELogo" height="60" width="60">
        </div> -->
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4 bg-gray">
            ...
            <a href="#" class="brand-link bg-gray">
                <img src="assets/dist/img/logo.jpeg" alt="webpro" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/user8-128x128.jpg" class="img-circle elevation-1" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Muhammad Faiz Alfangie</a>
                    </div>
                </div>
